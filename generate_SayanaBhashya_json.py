...
def bhashyaLinesAction(tokens):
    ...
    if len(tokens) <=2:
        ...
        if (int(anuvakaInfo) == 0):
            parseTree['TS']['SayanaBhashya']={}
            parseTree['TS']['SayanaBhashya']['Sloka']=tokens[2:]
            parseTree['TS']['SayanaBhashya']['header']=tokens[0:1]
        else:
            parseTree['TS']["Kanda"][kandaInfo-1]["Prasna"][prasnaInfo-1]["Anuvakkam"][anuvakaInfo-1]['SayanaBhashya']={}

            parseTree['TS']["Kanda"][kandaInfo-1]["Prasna"][prasnaInfo-1]["Anuvakkam"][anuvakaInfo-1]['SayanaBhashya']["Sloka"]=tokens[2:]
            parseTree['TS']["Kanda"][kandaInfo-1]["Prasna"][prasnaInfo-1]["Anuvakkam"][anuvakaInfo-1]['SayanaBhashya']["header"]=tokens[0:1]
...
for file_name in sys.argv[1:]:
    ...
    #print(results)
json_file_name = "TS_withSayanaBhashya.json"
